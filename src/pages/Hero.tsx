    ...
    <div className="w-full md:w-full lg:w-auto xl:w-auto relative overflow-clip min-h-[100svh] text-white bg-[linear-gradient(to_bottom,#000,#071E18_35%,#208A65_67%,#35FB8E_85%)]">
      ...
      <div className="container relative mx-auto px-4 pt-8 md:pt-12 pb-12 md:pb-24 min-h-[100svh] flex items-center">
        <div className="flex flex-col items-center justify-center text-center z-10 w-full">
          <Suspense fallback={<div className="mb-4 md:mb-8 mt-12 md:mt-24" />}>
            <MotionDiv
          ...
          <Suspense fallback={<div className="max-w-2xl mx-auto" />}>
            ...
            >
              ...
              <div className="flex gap-4 justify-center">
                <Suspense fallback={<button className="px-6 py-3 bg-emerald-500 rounded-full font-medium">Contact Me</button>}>
                  <MotionDiv
                ...
                <Suspense fallback={<button className="px-6 py-3 border border-white/20 rounded-full font-medium">View Work</button>}>
                  <MotionDiv
                    whileHover={{ scale: 1.05 }}
